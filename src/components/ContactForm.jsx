    ...
    <div className="bg-white p-8 rounded-lg shadow-lg">
      ...
      <div className="mt-6 p-4 bg-blue-50 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Note:</strong> To enable the contact form, you'll need to set
          up EmailJS with your credentials. Replace the placeholder values in
          the ContactForm component with your actual EmailJS service ID,
